...
def tag_special_ingredients(dish):
    ...
    """
    dish_name, ingredients = dish  # unpack tuple

    # Ensure ingredients are a set (handles both lists and sets)
    ingredient_set = set(ingredients)

    # Find intersection with special ingredients
...
def singleton_ingredients(dishes, intersection):
    ...
    # Subtract ingredients that appear in multiple dishes
    singleton_set = all_ingredients - set(intersection)
